...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString*)identifier {
	...
	if (self = [super initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier]) {
        ...
        _checkmarkImgView = [[UIImageView alloc] initWithFrame:CGRectMake(15.f, ICON_HEIGHT/2, CHECKMARK_WIDTH, CHECKMARK_HEIGHT)];//initWithImage:[UIImage imageNamed:@"checkbox+check.png"]];
        ...
        _companyLabel.textAlignment = UITextAlignmentLeft;
        ...
        _tsLabel.textAlignment = UITextAlignmentRight;
        _tsLabel.backgroundColor = [UIColor clearColor];
        
        _peopleImgView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"tile_icon_people.png"]];
        _peopleImgView.tag = 1;

        _payloadImgView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"tile_icon_shared.png"]];
        _payloadImgView.tag = 2;
        
        _peopleCountLabel = [[UILabel alloc] init];
        _peopleCountLabel.font = [UIFont systemFontOfSize:10];
        _peopleCountLabel.textAlignment = UITextAlignmentLeft;
...
-(void)setObject:(id)object {
    ...
    _iconView.urlPath = item.icon;
    _nameLabel.text = item.name;
    
//    self.accessoryType = item.checked ? UITableViewCellAccessoryCheckmark : UITableViewCellAccessoryNone;
    if (item.checked) {
        [_checkmarkImgView setImage:[UIImage imageNamed:@"checkbox_checked1.png"]];  //@"checkbox+check.png"
    } else {
